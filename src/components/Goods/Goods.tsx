...
export default function Goods() {
  return (
    <section className="goodsSection">
      <section className="goodsSectionContainer">
        <section className="box">
          ...
          <h3>Missão</h3>
          <p>
            Oferecer soluções tecnológicas acessíveis e inovadoras que capacitem
            microempreendedores a <strong>expandir seus negócios</strong>,
            aumentando sua competitividade e presença digital de forma simples e
            eficiente.
          </p>
        </section>
        ...
        <section className="box">
          ...
          <p>
            ...
            promovendo strong inclusão tecnológica e impulsionando o{" "}
        ...
        <section className="box">
          ...
          <ul>
            <li>
              <strong>Agilidade:</strong> Buscamos sempre soluções que entragam
              o maior valor possivel no menor tempo viavel.
            </li>
            <li>
